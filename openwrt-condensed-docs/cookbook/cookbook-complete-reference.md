...
> **Era:** Current (23.x+). Patterns labeled [WRONG](../L2-semantic/cookbook/uci-read-write-from-ucode.md) are common in AI output trained on generic Linux resources or older OpenWrt examples.
...
This page catalogs seven recurring mistake categories with concrete [WRONG](../L2-semantic/cookbook/uci-read-write-from-ucode.md)/[CORRECT](../L2-semantic/cookbook/uci-read-write-from-ucode.md) pairs. Each mistake is grounded in actual reference material from the OpenWrt corpus rather than speculation.
