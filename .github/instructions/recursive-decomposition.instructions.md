...
<!-- Source: recursive-decomposition skill - auto-generated by install-claude-skills.ps1 -->
<!-- Purpose: Handle long-context tasks (100+ files) and complex refactoring -->
...
1. **Filter** â€” Narrow search space before deep analysis
2. **Chunk** â€” Partition inputs strategically
3. **Recurse** â€” Spawn sub-agents for independent segments
4. **Verify** â€” Re-check answers on smaller, focused windows
5. **Synthesize** â€” Aggregate results programmatically
...
Results:
â”œâ”€â”€ Files scanned: 142
â”œâ”€â”€ Files with API calls: 18
â”œâ”€â”€ Patterns identified: 8 distinct patterns
â”œâ”€â”€ Anti-patterns detected: 4
â””â”€â”€ Output: Comprehensive report with file:line references
```
...
- Single file edits â†’ Direct processing is faster
- Specific function lookup â†’ Use Grep directly
- Tasks < 30k tokens â†’ Overhead not worth it
- Time-critical operations â†’ Latency matters more than completeness
...
```
1000 files â†’ Glob filter â†’ 100 files
100 files  â†’ Grep filter â†’ 20 files
20 files   â†’ Deep analysis
```
...
```
Main Agent
â”œâ”€â”€ Sub-Agent 1 (Batch A) â”€â”
â”œâ”€â”€ Sub-Agent 2 (Batch B) â”€â”¼â”€â”€ Parallel
â”œâ”€â”€ Sub-Agent 3 (Batch C) â”€â”˜
...
â”œâ”€â”€ plugins/
â”‚   â””â”€â”€ recursive-decomposition/
...
>
> arXiv:2512.24601 â€¢ December 2025
>
...
**Massimo De Luisa** â€” [@massimodeluisa](https://x.com/massimodeluisa)
